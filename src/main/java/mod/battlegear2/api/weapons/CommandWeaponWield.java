package mod.battlegear2.api.weapons;
...
public class CommandWeaponWield extends CommandBase{
    ...
    @Override
    public void execute(ICommandSender var1, String[] var2) throws PlayerNotFoundException, WrongUsageException {
        if(var2!=null) {
            ...
            if (var2.length == 2) {
                ...
                if(var2[0].equals(searchModes[0]))
                    ...
                    if(splits.length == 2)
                        itemStack = new ItemStack(GameRegistry.findItem(splits[0], splits[1]));
                }
            }
