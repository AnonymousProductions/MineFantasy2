...
public class TileEntityResearch extends TileEntity implements IInventory, IBasicMetre,IUpdatePlayerListBox
{
	...
	private void addProgress(EntityPlayer user)
	{
		...
		worldObj.playSoundEffect(this.getPos().getX()+0.5, this.getPos().getY()+0.5, this.getPos().getZ()+0.5, "minefantasy2:updateResearch", 1.0F, rand.nextFloat()*0.4F+0.8F);
		progress += efficiency;
	}
