...
public class ArmourListMF
{
	...
	public static void init() 
	{
		...
		cogwork_armour_helmet = (ItemArmourMF) new ItemCogworkArmour("cogwork_armour_helmet", ArmourDesign.COGWORK, BaseMaterialMF.cogworks, 0, "cogwork_armour_layer_1", 2).setContainerItem(cogwork_frame_helmet);
		cogwork_armour_chest = (ItemArmourMF) new ItemCogworkArmour("cogwork_armour_chest", ArmourDesign.COGWORK, BaseMaterialMF.cogworks, 1, "cogwork_armour_layer_1", 2).setContainerItem(cogwork_frame_chest);
		cogwork_armour_legs = (ItemArmourMF) new ItemCogworkArmour("cogwork_armour_legs", ArmourDesign.COGWORK, BaseMaterialMF.cogworks, 2, "cogwork_armour_layer_2", 2).setContainerItem(cogwork_frame_legs);
		cogwork_armour_boots = (ItemArmourMF) new ItemCogworkArmour("cogwork_armour_boots", ArmourDesign.COGWORK, BaseMaterialMF.cogworks, 3, "cogwork_armour_layer_1", 2).setContainerItem(cogwork_frame_boots);
