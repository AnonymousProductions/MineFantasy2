...
public class TongsSmartItemModel implements ISmartItemModel{
	/**
	  ...
	  {
	    baseTongsModel = i_basetongsModel;
	  }
	  ...
	  //public static final ModelResourceLocation modelResourceLocation= new ModelResourceLocation("minefantasy2:"+item.getName(), "inventory");
	  ...
	  public IBakedModel handleItemState(ItemStack stack) {
	    if (stack != null) {
	      held = TongsHelper.getHeldItem(stack);
	    }
	    return this;
	  }
	  ...
	  public TextureAtlasSprite getTexture() {
	    return baseTongsModel.getTexture();
	  }
	  ...
	  public List getFaceQuads(EnumFacing enumFacing) {
	    return baseTongsModel.getFaceQuads(enumFacing);
	  }
...
//	    List<BakedQuad> combinedQuadsList = new ArrayList();
	    ...
	    List<BakedQuad> combinedQuadsList = new ArrayList(baseTongsModel.getGeneralQuads());
	    combinedQuadsList.addAll(getTongsQuads(held));
...
//	    FaceBakery.makeBakedQuad() can be useful for generating quads
	  ...
	  public boolean isAmbientOcclusion() {
	    return baseTongsModel.isAmbientOcclusion();
	  }

	  @Override
	  public boolean isGui3d() {
	    return baseTongsModel.isGui3d();
	  }
	  ...
	  public ItemCameraTransforms getItemCameraTransforms() {
	    return baseTongsModel.getItemCameraTransforms();
	  }

	  // return a list of BakedQuads for drawing the chess pieces
	  public List<BakedQuad> getTongsQuads(ItemStack held)
	  {

	    TextureAtlasSprite tongsTexture = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("minecraft:blocks/diamond_block");
	    TextureAtlasSprite heldTexture = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("minecraft:items/"+held.getItem());
