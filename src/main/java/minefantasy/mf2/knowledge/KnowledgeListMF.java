...
public class KnowledgeListMF
{
	...
	public static InformationBase research1 = (new InformationBase("research1", 				1, 1, 50, ToolListMF.researchBook, (InformationBase)null)).registerStat().setPerk();
	public static InformationBase research2 = (new InformationBase("research2", 				3, 1, 80, Items.enchanted_book, research1)).registerStat().setPerk();
    ...
    public static InformationBase smeltSteel = (new InformationBase("smeltSteel",  				4, 5, 10, ComponentListMF.ingots[4], blastfurn)).registerStat().setPage(smithing).setUnlocked().addSkill(SkillList.metallurgy, 30);
    public static InformationBase encrusted = (new InformationBase("smeltEncrusted",  			6, 5, 10, ComponentListMF.diamond_shards, smeltSteel)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 35);
    public static InformationBase smeltBlackSteel = (new InformationBase("smeltBlackSteel",		4, 7, 10, ComponentListMF.ingots[7], smeltSteel)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 50);
    public static InformationBase smeltDragonforge = (new InformationBase("smeltDragonforge",	6, 7, 50, ToolListMF.swords[7], smeltBlackSteel)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 60);
    ...
    public static InformationBase craftAdvWeapons = (new InformationBase("craftAdvWeapons",     -5, 1, 10, ToolListMF.battleaxes[3], craftWeapons)).registerStat().setPage(smithing).setUnlocked();
    ...
    public static InformationBase craftAdvOrnateWeapons = (new InformationBase("craftAdvOrnateWeapons", 	-5, -1, 25, ToolListMF.battleaxes[2], craftOrnateWeapons)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 0);
    public static InformationBase craftArmourLight = (new InformationBase("craftArmourLight", 			-3, 3, 0, ArmourListMF.armour(ArmourListMF.leather, 3, 1), anvil)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 0);
    public static InformationBase craftArmourMedium = (new InformationBase("craftArmourMedium", 		-4, 3, 5, ArmourListMF.armour(ArmourListMF.chainmail, 3, 1), craftArmourLight)).registerStat().setPage(smithing);
    public static InformationBase craftArmourHeavy = (new InformationBase("craftArmourHeavy",       	-5, 3, 10, ArmourListMF.armour(ArmourListMF.fieldplate, 3, 1), craftArmourMedium)).registerStat().setPage(smithing).addSkill(SkillList.metallurgy, 10);
    public static InformationBase arrows = (new InformationBase("arrows", 		  		   		 -3, 4, 10, ToolListMF.arrows[4], anvil)).registerStat().setPage(smithing).setUnlocked();
    public static InformationBase arrowsBodkin = (new InformationBase("arrowsBodkin", 		  	 -4, 5, 15, ToolListMF.bodkinArrows[3], arrows)).registerStat().setPage(smithing);
    public static InformationBase arrowsBroad = (new InformationBase("arrowsBroad", 		  	 -5, 5, 20, ToolListMF.broadArrows[3], arrows)).registerStat().setPage(smithing);
