...
public class KnowledgeListMF
{
	...
	public static InformationBase crucible2 = (new InformationBase("crucible2",  				6, 0, 10, BlockListMF.crucibleadv_active, crucible)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 40).setTalismanCount(4);
	...
	public static InformationBase smeltBronze = (new InformationBase("smeltBronze",  			1, 2,  5, ComponentListMF.ingots[2], crucible)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 5).setTalismanCount(0);
    ...
    public static InformationBase blastfurn = (new InformationBase("blastfurn",  				2, 5, 15, BlockListMF.blast_heater_active, smeltIron)).registerStat().setPage(artisanry).setSpecial().addSkill(SkillList.metallurgy, 30).setTalismanCount(8);
    ...
    public static InformationBase smeltDragonforge = (new InformationBase("smeltDragonforge",	6, 7, 15, ToolListMF.swords[7], smeltBlackSteel)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 60).setTalismanCount(16);
    public static InformationBase smeltRedSteel = (new InformationBase("smeltRedSteel", 		3, 9, 10, ComponentListMF.ingots[10], smeltBlackSteel)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 65).setTalismanCount(16);
    public static InformationBase smeltBlueSteel = (new InformationBase("smeltBlueSteel", 		5, 9, 10, ComponentListMF.ingots[12], smeltBlackSteel)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 65).setTalismanCount(16);
    ...
    public static InformationBase craftAdvTools = (new InformationBase("craftAdvTools", 		-5, 2, 0, ToolListMF.hvypicks[2], craftTools)).registerStat().setPage(artisanry).setUnlocked();
    ...
    public static InformationBase craftAdvWeapons = (new InformationBase("craftAdvWeapons",     -5, 1, 0, ToolListMF.battleaxes[3], craftWeapons)).registerStat().setPage(artisanry).setUnlocked();
    ...
    public static InformationBase craftAdvOrnateWeapons = (new InformationBase("craftAdvOrnateWeapons", 	-5, -1, 15, ToolListMF.battleaxes[2], craftOrnateWeapons)).registerStat().setPage(artisanry).addSkill(SkillList.metallurgy, 0).setTalismanCount(4);
    ...
    public static InformationBase arrows = (new InformationBase("arrows", 		  		   		 -3, 4, 0, ToolListMF.arrows[4], anvil)).registerStat().setPage(artisanry).setUnlocked();
    public static InformationBase arrowsBodkin = (new InformationBase("arrowsBodkin", 		  	 -4, 5, 10, ToolListMF.bodkinArrows[3], arrows)).registerStat().setPage(artisanry);
    public static InformationBase arrowsBroad = (new InformationBase("arrowsBroad", 		  	 -5, 5, 10, ToolListMF.broadArrows[3], arrows)).registerStat().setPage(artisanry);
    
    //ENGINEERING - Highly Expensive
    public static InformationBase blackpowder = (new InformationBase("blackpowder", 			0, 0, 10, ComponentListMF.blackpowder, (InformationBase)null)).registerStat().setPage(engineering).setTalismanCount(4);
    public static InformationBase advblackpowder = (new InformationBase("advblackpowder", 		2, -2, 30, ComponentListMF.blackpowder_advanced, blackpowder)).registerStat().setPage(engineering).setTalismanCount(8);
    ...
    public static InformationBase shrapnel = (new InformationBase("shrapnel", 				    0, 4, 20, ComponentListMF.shrapnel, bombs)).registerStat().setPage(engineering).setTalismanCount(4);
    public static InformationBase firebomb = (new InformationBase("firebomb", 		  		    0, 6, 30, Items.blaze_powder, shrapnel)).registerStat().setPage(engineering).setTalismanCount(8);
    public static InformationBase stickybomb = (new InformationBase("stickybomb", 			   -2, 2, 30, Items.slime_ball, bombs)).registerStat().setPage(engineering).setTalismanCount(8);
    ...
    public static InformationBase bombIron = (new InformationBase("bombIron", 				    4, 5, 10, ComponentListMF.bomb_casing_iron, bombCeramic)).registerStat().setPage(engineering).setTalismanCount(2);
    public static InformationBase bombObsidian = (new InformationBase("bombObsidian", 		    4, 7, 15, ComponentListMF.bomb_casing_obsidian, bombIron)).registerStat().setPage(engineering).setTalismanCount(4);
    public static InformationBase bombCrystal = (new InformationBase("bombCrystal", 		    2, 9, 20, ComponentListMF.bomb_casing_crystal, bombObsidian)).registerStat().setPage(engineering).setTalismanCount(8);
    public static InformationBase mineCeramic = (new InformationBase("mineCeramic", 		   -2, 3, 5,  ComponentListMF.mine_casing, bombCeramic)).registerStat().setPage(engineering);//2 gold, 4 silver
    public static InformationBase mineIron = (new InformationBase("mineIron", 				   -4, 5, 10, ComponentListMF.mine_casing_iron, mineCeramic)).registerStat().setPage(engineering).setTalismanCount(2);
    public static InformationBase mineObsidian = (new InformationBase("mineObsidian", 		   -4, 7, 15, ComponentListMF.mine_casing_obsidian, mineIron)).registerStat().setPage(engineering).setTalismanCount(4);
    public static InformationBase mineCrystal = (new InformationBase("mineCrystal", 		   -2, 9, 20, ComponentListMF.mine_casing_crystal, mineObsidian)).registerStat().setPage(engineering).setTalismanCount(8);
    ...
    public static InformationBase repair_advanced = (new InformationBase("repair_advanced",    10, 0, 15, BlockListMF.repair_advanced, repair_basic)).registerStat().setPage(artisanry).setTalismanCount(2);
    public static InformationBase repair_ornate = (new InformationBase("repair_ornate",        12, 2, 20, BlockListMF.repair_ornate, repair_advanced)).registerStat().setPage(artisanry).setTalismanCount(4);
    ...
    public static InformationBase jerky = (new InformationBase("jerky",             0,  -5, 5, FoodListMF.jerky, stew)).registerStat().setPage(provisioning).setTalismanCount(0);
    ...
    public static InformationBase meatpie = (new InformationBase("meatpie",   		-1,  -7, 20, BlockListMF.pie_meat, jerky)).registerStat().setPage(provisioning).setTalismanCount(2);
    public static InformationBase shepardpie = (new InformationBase("shepardpie",  	-2,  -9, 25, BlockListMF.pie_shepards, meatpie)).registerStat().setPage(provisioning).setTalismanCount(4);
    ...
    public static InformationBase salt = (new InformationBase("salt",            	-2,  -2, 0, FoodListMF.salt, (InformationBase)null)).registerStat().setPage(provisioning).setUnlocked();
    ...
    public static InformationBase sweetroll = (new InformationBase("sweetroll",      0,  3, 5, FoodListMF.sweetroll, berry)).registerStat().setPage(provisioning).setTalismanCount(0);
    public static InformationBase cake = (new InformationBase("cake",	 	         0,  5, 15, BlockListMF.cake_vanilla, sweetroll)).registerStat().setPage(provisioning).setTalismanCount(2);
    public static InformationBase carrotcake = (new InformationBase("carrotcake",	-1,  7, 10, BlockListMF.cake_carrot, cake)).registerStat().setPage(provisioning).setTalismanCount(4);
    public static InformationBase chococake = (new InformationBase("chococake",	 	 1,  7, 20, BlockListMF.cake_chocolate, cake)).registerStat().setPage(provisioning).setTalismanCount(4);
    public static InformationBase bfcake = (new InformationBase("bfcake",	 	     1,  9, 25, BlockListMF.cake_bf, chococake)).registerStat().setPage(provisioning).setTalismanCount(8);
    public static InformationBase berrypie = (new InformationBase("berrypie",	 	 2,  1, 10, BlockListMF.pie_berry, berry)).registerStat().setPage(provisioning).setTalismanCount(2);
    public static InformationBase applepie = (new InformationBase("applepie",	 	 4,  1, 10, BlockListMF.pie_apple, berrypie)).registerStat().setPage(provisioning).setTalismanCount(2);
    ...
    public static InformationBase bandage = (new InformationBase("bandage",	        -3, 0,  0,  ToolListMF.bandage_wool, (InformationBase)null)).registerStat().setPage(provisioning).setUnlocked();
    public static InformationBase bandageadv = (new InformationBase("bandageadv",	-5, -1, 10, ToolListMF.bandage_tough, bandage)).registerStat().setPage(provisioning).setTalismanCount(2);
