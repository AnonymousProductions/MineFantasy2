...
public class ForgedToolRecipes 
{
	...
	private static void addStandardCrafters(CustomMaterial material, ItemStack ingot) 
	{
		...
		MineFantasyAPI.addAnvilRecipe(artisanry, CustomToolListMF.standard_shears.construct(material.name), "smelt"+material.name, true, "hammer", material.crafterTier, material.crafterAnvilTier, (int)(time*material.craftTimeModifier), new Object[]
		{
			" I ",
			"PLI",
			" P ",
		...
		Salvage.addSalvage(CustomToolListMF.standard_shears.construct(material.name),
				salvage, salvage,
				plank, plank,
				Items.leather);
