...
public class GuiCrucible extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
    {
        ...
        if(tile.getStackInSlot(tile.getSizeInventory()-1) != null && !(tile.getStackInSlot(tile.getSizeInventory()-1).getItem() instanceof ItemBlock) && ConfigHardcore.HCCreduceIngots)
        {
