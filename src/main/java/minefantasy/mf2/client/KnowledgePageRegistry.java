...
public class KnowledgePageRegistry
{
	public static void registerPages()
	{
		...
		KnowledgeListMF.gettingStarted.addPages(new EntryPageText("knowledge.gettingStarted.tanning"), new EntryPageRecipeBase(KnowledgeListMF.tannerRecipe), new EntryPageRecipeCarpenter(KnowledgeListMF.stoneKnifeR));
		KnowledgeListMF.gettingStarted.addPages(new EntryPageText("knowledge.gettingStarted.forging"), new EntryPageText("knowledge.gettingStarted.forging.2"), new EntryPageRecipeBase(KnowledgeListMF.stoneAnvilRecipe), new EntryPageRecipeBase(KnowledgeListMF.forgeRecipe), new EntryPageRecipeCarpenter(KnowledgeListMF.stoneHammerR), new EntryPageRecipeCarpenter(KnowledgeListMF.stoneTongsR), new EntryPageRecipeCarpenter(KnowledgeListMF.dryrocksR), new EntryPageRecipeBase(KnowledgeListMF.apronRecipe));
		...
		KnowledgeListMF.gettingStarted.addPages(new EntryPageText("knowledge.gettingStarted.10"), new EntryPageRecipeCarpenter(KnowledgeListMF.potRecipe), new EntryPageSmelting(ComponentListMF.clay_pot_uncooked, ComponentListMF.clay_pot), new EntryPageRecipeCarpenter(KnowledgeListMF.pestleR), new EntryPageText("knowledge.gettingStarted.11"), new EntryPageText("knowledge.gettingStarted.12"));
		KnowledgeListMF.gettingStarted.addPages(new EntryPageRecipeBase(KnowledgeListMF.bSalvageR), new EntryPageText("knowledge.gettingStarted.13"), new EntryPageText("knowledge.gettingStarted.14"));
		...
		KnowledgeListMF.talisman.addPages(new EntryPageRecipeBase(KnowledgeListMF.artBook2R), new EntryPageRecipeBase(KnowledgeListMF.conBook2R), new EntryPageRecipeBase(KnowledgeListMF.proBook2R), new EntryPageRecipeBase(KnowledgeListMF.engBook2R), new EntryPageRecipeBase(KnowledgeListMF.comBook2R));
		...
		KnowledgeListMF.salvage.addPages(new EntryPageText("knowledge.salvage.1"), new EntryPageRecipeBase(KnowledgeListMF.bSalvageR), new EntryPageText("knowledge.salvage.2"));
		...
		KnowledgeListMF.dust.addPages(new EntryPageText("knowledge.dust.1"), new EntryPageRecipeCarpenter(KnowledgeListMF.potRecipe), new EntryPageSmelting(ComponentListMF.clay_pot_uncooked, ComponentListMF.clay_pot), new EntryPageRecipeCarpenter(KnowledgeListMF.pestleR));
	    ...
	    KnowledgeListMF.tungsten.addPages(new EntryPageText("knowledge.tungsten.1"), new EntryPageText("knowledge.tungsten.2"), new EntryPageCrucible(KnowledgeListMF.wolframiteR));
	    ...
	    KnowledgeListMF.blackpowder.addPages(new EntryPageText("knowledge.blackpowder.1"),new EntryPageText("knowledge.blackpowder.2"), new EntryPageRecipeCarpenter(KnowledgeListMF.coalDustR), new EntryPageRecipeCarpenter(KnowledgeListMF.blackpowderRec), new EntryPageRecipeCarpenter(KnowledgeListMF.crudeBombR));
